...
<head>
  ...
  <link rel="stylesheet" href="<?= $_SERVER['BASE_URI']?>/css/blog.css">
    ...
    <nav class="navbar navbar-expand-md navbar-light">
      <!--
        ...
        xxx correspond à une taille (media-query) définie dans Bootstrap.
          ...
          xl => 1200px
        -->
      <a class="navbar-brand" href="<?= $_SERVER['BASE_URI']?>">A la dérive</a>
      ...
      <div class="collapse navbar-collapse justify-content-end" id="navbarNav">
        <ul class="navbar-nav ">
          ...
          ?>
          <li class="nav-item">
            <a class="nav-link" href="<?= $_SERVER['BASE_URI']; ?>/category/<?= $category->getId(); ?>"><?= $category->getName() ?></a>
          </li>
          <?php
          endforeach;
          ?>
