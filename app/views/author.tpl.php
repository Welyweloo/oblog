...
<div class="container">
    ...
    <div class="row">
      ...
      <main class="col-lg-9">
      <h1 class="card-title text-center">Articles de l'auteur <?= $datas[0] ?></h1>
        ...
        <article class="card">
          <div class="card-body">
            ...
            <p class="infos">
              Posté le <time datetime="<?= $article->getDate('datetime'); ?>"><?= $article->getDate('fr'); ?></time> dans <a href="<?= $_SERVER['BASE_URI']; ?>/category/<?= $article->getCategory_id(); ?>"
